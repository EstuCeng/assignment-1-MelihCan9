...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        while (you!=5 && com!=5) { //We use this loop-continuation-condition to end the game when a player reaches 5 points.
            ...
            int ai = 1 + (int) (Math.random() * 3); /*Computer picks a random number between 1 and 3 with using Math.random method.
            ...
            //Here, we want to match the words we get from the user and the words we define to the computer, even if there is a differences about their size of the letters.
            me=me.toLowerCase();
        ...
        //We use if-else, for ending game and determine the who is winner.Also if it was a 5-0 game, we can get a little teasing with each other.
        if(you<com){
